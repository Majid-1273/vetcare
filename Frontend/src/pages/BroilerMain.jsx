...
const BroilerMain = () => {
    ...
    // Pagination
    const broilerFlocks = flocks.filter(flock => flock.breedType.toLowerCase() === "broiler");
const indexOfLastItem = currentPage * itemsPerPage;
const indexOfFirstItem = indexOfLastItem - itemsPerPage;
const currentFlocks = broilerFlocks.slice(indexOfFirstItem, indexOfLastItem);
const totalPages = Math.ceil(broilerFlocks.length / itemsPerPage);
        ...
        <div className="h-[90vh] bg-white p-6">
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Broiler Chicken Details</h1>
                                    ...
                                    <th scope="col" className="w-12 px-4 py-3">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (selectedFlocks.length === broilerFlocks.length) {
                                                    setSelectedFlocks([]);
                                                } else {
                                                    setSelectedFlocks(broilerFlocks.map(flock => flock._id));
                                                }                                                
                                            }}
