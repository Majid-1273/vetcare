  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center bg-[#f9fef7] px-6 md:px-12 lg:px-20">
      ...
      <img
        ...
        className="absolute top-0 right-0 w-[60%] lg:w-[50%] z-0"
      />
      ...
      <div className="max-w-5xl w-full flex flex-col md:flex-row items-center justify-between relative z-10">
        <div className="md:w-1/2 text-left">
          ...
          <p className="mt-4 text-gray-600 text-lg">
            Streamline animal health records and optimize care with Vet Entry AI.
          </p>
          <Link
            to="/signup"
            className="mt-6 px-6 py-3 bg-[#A8E6CF] text-white text-lg font-semibold rounded-lg shadow-md hover:bg-[#a2d4b0] transition inline-block"
          >
            Get Started
          </Link>
        </div>
