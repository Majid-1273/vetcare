...
const LayerMain = () => {
    ...
    const fetchFlocks = async () => {
        try {
            ...
            // Only set layer flocks
            const layerFlocks = response.data.filter(flock => flock.breedType === "layer");
        ...
        <div className="h-[90vh] bg-white p-6">
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Layer Chicken Details</h1>
